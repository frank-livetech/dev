            ...
            for (var i = 0; i < data.length; i++) {
                ...
                row += `
                    <tr id="row_` + data[i].id + `" >
                        ...
                        <td>` + address + `` + apt_address + `<br>` + ct_name + ` ` + st_name + ` ` + zip + `<br>` + cn_name
                    ...
                    `</td>
                        ...
                        <td>` + moment(data[i].created_at).format(system_date_format) + `</td>
                            <td >
                                <button onclick="showdeleteModal(` + data[i].id + `)" class="btn btn-danger btn-sm rounded"><i class="fas fa-trash"></i> delete</button>
                            </td>
                        </tr>
                `;
                count++;
