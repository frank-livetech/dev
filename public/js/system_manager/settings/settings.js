...
$('#nestable-menu').on('click', function(e) {
    ...
    if (div == 'Tickets') {
        ...
        $('#settings_stats').css('display', 'none');
        $('#customer_settings').css('display', 'none');
        $('#security_settings').css('display', 'none');
        $('#system_settings').css('display', 'none');
        $('#branding_settings').css('display', 'none');
        $('#marketing_settings').css('display', 'none');
        $('#tickets_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#SLA_settings").css('display', 'none');

        $(".tickets").addClass("menu_active");

        $(".customer").removeClass("menu_active");
        $(".marketing").removeClass("menu_active");
        $(".security").removeClass("menu_active");
        $(".system").removeClass("menu_active");
        $(".branding").removeClass("menu_active");
        $(".menu_management").removeClass("menu_active");
        $(".main").removeClass("menu_active");
        $(".billing").removeClass("menu_active");
        $(".dispatch").removeClass("menu_active");
        $(".project").removeClass("menu_active");
        $(".SLA").removeClass("menu_active");
        ...
        $('#branding_settings').css('display', 'none');
        $('#marketing_settings').css('display', 'none');
        $('#tickets_settings').css('display', 'none');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'block');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        $("#SLA_settings").css('display', 'none');

        $(".billing").addClass("menu_active");
        ...
        $(".menu_management").removeClass("menu_active");
        $(".main").removeClass("menu_active");
        $(".tickets").removeClass("menu_active");
        $(".project").removeClass("menu_active");
        $(".dispatch").removeClass("menu_active");
        $(".SLA").removeClass("menu_active");
        ...
        $('#marketing_settings').css('display', 'none');
        $('#tickets_settings').css('display', 'none');
        $('#customer_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        ...
        $('#branding_settings').css('display', 'none');
        $('#tickets_settings').css('display', 'none');
        $('#marketing_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        ...
        $(".marketing").addClass("menu_active");
        ...
        $('#tickets_settings').css('display', 'none');
        $('#marketing_settings').css('display', 'none');
        $('#security_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        ...
        $('#marketing_settings').css('display', 'none');
        $('#security_settings').css('display', 'none');
        $('#system_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        ...
        $('#marketing_settings').css('display', 'none');
        $('#security_settings').css('display', 'none');
        $('#branding_settings').css('display', 'block');
        $("#menu_settings").css('display', 'none');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        ...
        $('#security_settings').css('display', 'none');
        $('#branding_settings').css('display', 'none');
        $("#menu_settings").css('display', 'block');
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        $("#SLA_settings").css('display', 'none');

        $(".menu_management").addClass("menu_active");
        ...
        $("#billing_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'block');
        $("#SLA_settings").css('display', 'none');
        ...
        $(".billing").removeClass("menu_active");
        $(".project").removeClass("menu_active");
        $(".dispatch").addClass("menu_active");
        $(".SLA").removeClass("menu_active");



    } else if (div == 'Project Management') {
        $('#settings_stats').css('display', 'none');
        $('#customer_settings').css('display', 'none');
        $('#system_settings').css('display', 'none');
        $('#tickets_settings').css('display', 'none');
        ...
        $("#billing_settings").css('display', 'none');
        $("#dispatch_settings").css('display', 'none');
        $("#project_settings").css('display', 'block');
        $("#SLA_settings").css('display', 'none');
        ...
        $("#dispatch_settings").css('display', 'none');
        $("#project_settings").css('display', 'none');
        $("#SLA_settings").css('display', 'block');
