! function(document, window, $) {
    ...
    $(document).ready(function($) {
            ...
            _createSelect: function() {
                var $result = $("<select>").attr("class", "form-control input-sm chosen"),
                    valueField = this.valueField,
                    textField = this.textField,
                    selectedIndex = this.selectedIndex;
                return $.each(this.items, function(index, item) {
                    var value = valueField ? item.id : index,
                        text = textField ? item.text : item,
        ...
        function() {
            $("#basicgrid").jsGrid({
                ...
                controller: db,
                fields: [{ type: "checkbox", title: "Select All", sorting: false }, {
                    name: "Id",
                    type: "number",
                    width: 50
                }, {
