                ...
                switch (t.SidebarType) {
                    case "full":
                        ...
                        $(window).ready(a), $(window).on("resize", a), $(".sidebartoggler").on("click", function() {
                            // icon toggler
                            $("#main-wrapper").toggleClass("mini-sidebar"), $("#main-wrapper").hasClass("mini-sidebar") ? ($(".icon-arrow-left-circle").css("display", "none"), $(".icon-arrow-right-circle").css("display", "block"), $(".sidebartoggler").prop("checked", !0), $("#main-wrapper").attr("data-sidebartype", "mini-sidebar")) : ($(".icon-arrow-left-circle").css("display", "block"), $(".icon-arrow-right-circle").css("display", "none"), $(".sidebartoggler").prop("checked", !1), $("#main-wrapper").attr("data-sidebartype", "full"))
                                //sidebar icon toggler
                        });
                        break;
                    case "mini-sidebar":
