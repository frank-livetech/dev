        ...
        foreach ($data_list as $key => $data) {
            ...
            if($data['module'] == 'Customer') {
                ...
                if(str_contains($template, '{Ticket-Status-Name}')) {
                    ...
                    $status_badge = '<span class="badge" style="background:'.$status['color'].'; padding: 2px 12px; border-radius: 20px; color: white; font-size: 14px;"> '. $status['name'] .'</span>';
                ...
                if(str_contains($template, '{Ticket-Priority-Name}')) {
                    ...
                    $priority_badge = '<span class="badge" style="background-color:'.$priority['priority_color'].'; padding: 2px 12px; border-radius: 20px; color: white; font-size: 14px;"> '. $priority['name'] .'</span>';
