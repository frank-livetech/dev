        ...
        if($type == 'clockin') {
            ...
            if(str_contains($template, '{New-Tickets}')) {
                ...
                foreach($todayTickets as $tk) {
                    ...
                    $newTicket .= "<p class='tkt_details'><a href='$tkUrl'>$tk->coustom_id</a> &nbsp; Status:  <span style='color:$tk->status_color'>$tk->status_name</span> &nbsp; Priority:  <span style='color:$tk->priority_color'>$tk->priority_name</span></p><p style='line-height: 18px !important'>$tk->subject</p>";
                }
            ...
            if(str_contains($template, '{Overdue-Tickets}')) {
                ...
                foreach($overdueTickets as $tk) {
                    ...
                    $tkUrl = request()->root() . '/ticket-details' .'/'.$tk->coustom_id;
                    $newTicket .= "<p class='tkt_details'><a href='$tkUrl'>$tk->coustom_id</a> - <span style='color:$tk->status_color'>$tk->status_name</span> - <span style='color:$tk->priority_color'>$tk->priority_name</span></p><p style='line-height: 18px !important'>$tk->subject</p>";
                }
