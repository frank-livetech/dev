...
class mailEclipse
{
    ...
    public static $prefix_view = 'system_manager.template_builder.';
    ...
    public static function deleteTemplate($templateSlug)
    {
        ...
        if (! is_null($template)) {
            ...
            $template_view = 'vendor.maileclips.templates.'.$templateSlug;
    ...
    public static function updateTemplate($request)
    {
        ...
        if (! is_null($template)) {
            ...
            $template_view = 'templates.'.$request->templateslug;
            $template_plaintext_view = $template_view.'_plain_text';
    ...
    public static function getTemplate($templateSlug)
    {
        ...
        if (! is_null($template)) {
            ...
            if(!(View::exists($template_view))){
                $template_view = 'vendor.maileclipse.'.$template_view;
                $template_plaintext_view = $template_view.'_plain_text';
    ...
    public static function createTemplate($request)
    {
        ...
        $view = 'templates.'.$request->template_name;
    ...
    public static function getTemplateSkeleton($type, $name, $skeleton)
    {
        // $skeletonView = self::$view_namespace."::skeletons.{$type}.{$name}.{$skeleton}";
         $skeletonView = self::$prefix_view."skeletons.{$type}.{$name}.{$skeleton}";
    ...
    {
        if ($template && View::exists('templates.'.$viewPath)) {
            $viewPath = View('templates.'.$viewPath)->getPath();
        }
    ...
    public static function previewMarkdownViewContent($simpleview, $content, $viewName, $template = false, $namespace = null)
    {
        ...
        if (file_exists($dir)) {
            ...
            return self::renderPreview($simpleview, 'draft.'.$viewName, $template, $instance);
        }
