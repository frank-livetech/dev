        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{asset('/save_rfq_requests')}}" class="form-horizontal mt-4" id="rfq_form">
                        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <button onclick="showVendorModel()" type="button" class="btn btn-success btn-sm rounded" style="float:right;"><i class="mdi mdi-plus-circle" style=""></i>&nbsp;Add New</button>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal mt-4" id="save_vendor_form" action="{{asset('/save-vendor')}}" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="padding-top: 20px;">
                                    <button class="btn btn-success" style="" id="add_category_btn"><i class="mdi mdi-plus"></i>Add</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="checkbox checkbox-primary">
                                        <input id="checkbox3" type="checkbox" name="has_account">
