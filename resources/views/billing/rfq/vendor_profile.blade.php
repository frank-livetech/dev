            ...
            <div class="card">
                <div class="card-body">
                    <center class="mt-4">
                        ...
                        <h4 class="card-title mt-2" id="cust_name">tech No
                        </h4>
                ...
                <div class="card-body">
                        ...
                        <h6> <a href="tel:0303-03030303" id="cust_phone">0303-03030303</a> </h6>                    

                        <div id="adrs">
                            <small class="text-muted  db">Email Address</small>
                            <input type="hidden" id="cust_email1" value="email.livetech.com">
                            <h6> <a href="mailto:email.livetech.com" id="cust_email"> email.livetech.com</a></h6>
                        </div>                   
                        ...
                        <div>
                            <span id="cust_city">Vendor City</span>
                                ...
                                <span id="cust_state">Cust State</span>
                            ...
                            <span id="cust_country">Country</span>
        ...
        <div class="col-lg-9 col-xlg-9 col-md-7">
            ...
            <div class="card"><grammarly-extension data-grammarly-shadow-root="true" style="position: absolute; top: -1px; left: -1px; pointer-events: none;" class="cGcvT"></grammarly-extension>
                ...
                <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-setting-tab" data-toggle="pill" href="#previous-month" role="tab" aria-controls="pills-setting" aria-selected="true">User Profile</a>
                    </li>
                    <!-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="orders-profile-tab" data-toggle="pill" href="#orders" role="tab" aria-controls="pills-profile" aria-selected="false">Orders</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" id="pills-timeline-tab" data-toggle="pill" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="false">History</a>
                    </li> -->
                    <!--<li class="nav-item">-->
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" id="prof_twitter"
                                            value="" name="twitter" placeholder="https://twitter.com/username">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label>Facebook</label>
                                        <input type="text" name="fb" class="form-control" id="prof_fb" value=""
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="insta" class="form-control" id="prof_insta"
                                            value="" placeholder="https://instagram.com/username">
                                    </div>
                                    <div class="col-md-6 form-group">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn btn-info mr-auto" data-toggle="modal" data-target="#Add-new-card" style="float:right;"><i class="mdi mdi-plus-circle"></i>&nbsp;Add New Card</button>
                                </div>
                            </div>
                        ...
                        <!-- <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-xlg-4" style="padding-top:25px">
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#assetModal" style="float:right;margin-bottom:5px;top: -35px;position: relative;"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;Add Asset</button>
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#assetCatModal" style="float:right;top: -35px;position: relative;"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;Add Asset Category</button>
                                </div>
