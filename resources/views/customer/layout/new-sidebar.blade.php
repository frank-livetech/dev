...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content mt-2" >
            <ul class="navigation navigation-main sidna" id="sidebarnav"  data-menu="menu-navigation">
                <li class=" nav-item  {{ (request()->is('user/myprofile')) ? 'active' : '' }}">
                ...
                <li class=" nav-item {{ Request::segment(1) == 'user/tickets/list' ? 'active' : '' }}">
                ...
                <li class=" nav-item {{ (request()->is('user/submitTicket')) ? 'active' : '' }}">
