                                ...
                                <ol class="breadcrumb">
                                    ...
                                    @if ($name != '')
                                        <li class="breadcrumb-item active"> <a
                                                href="javascript:location.reload()">{{ $dept_name }} /
                                                {{ $status_name }}</a> </li>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:getCounterTickets('total')">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-info">All Tickets
                                                    </h5>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:getCounterTickets('self')">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-success">My
                                                        Tickets</h5>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:getCounterTickets('unassigned')">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-primary">
                                                        Unassigned</h5>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:getCounterTickets('overdue')">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-danger">Overdue
                                                    </h5>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:getCounterTickets('flagged')">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-danger">Flagged
                                                    </h5>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-row">
                                            <div class="my-auto" style="text-align: center">
                                                <a href="javascript:void(0)">
                                                    ...
                                                    <h5 class="card-text font-small-10 mb-0 mt-1 text-success">Trash
                                                    </h5>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive" style="overflow: hidden;">
                                    <span class="fw-bolder">
                                        <div class="total_selected_tkts d-none">
                                            <span class="total_tickets">0</span> ticket selected
                                    </span>
                                </div>
...
<script>
    ...
    $('.content').on('mouseenter', '.ticket_name', function() {
        ...
        if (item != null) {
                ...
                if (attchs != '') {
                    ...
                    attchs.forEach(attach => {
                        ...
                        <div class="col-md-2" style='position:relative;cursor:pointer' >
                            ...
                            `
                        } else if (ter == "png" || ter == "jpg" || ter == "webp" || ter == "jpeg" ||
                            ter == "webp" || ter == "svg" || ter == "psd") {
                            attachments += `<div class="col-md-2" style='position:relative;cursor:pointer' >
                            ...
                            `
                        } else if (ter == "docs" || ter == "doc" || ter == "txt" || ter == "dotx" ||
                            ter == "docx") {
                            attachments += `<div class="col-md-2" style='position:relative;cursor:pointer' >
                                    <div class="card" style='border:1px solid #c7c7c7;border-radius: 3px !important;margin-bottom: 1rem;'>
                                        <div class="card-body" style="padding: .3rem .3rem !important;background-color:#dfdcdc1f">
            ...
            if (item.last_reply != null) {
                parserReplyEmbeddedImages(`reply-html-${id}`, `${item.last_reply.embed_attachments}`,
                    `${item.last_reply.type}`, `${id}`);
            } else {
                parserIntitialRequestEmbeddedImages(`ticket_details_p_${id}`, `${item.embed_attachments}`,
                    `${id}`);
            }
        }
    ...
    function parserIntitialRequestEmbeddedImages(reply_id, images, id) {
        ...
        $('#' + reply_id + ' img').each(function() {
            ...
            if (attchs[index] == undefined || attchs[index] == null) {
                if (classList != 'rounded-circle' && classList != 'attImg' && classList != 'img-fluid' &&
                    type == 'cron') {
