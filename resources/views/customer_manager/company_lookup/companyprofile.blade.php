...
@section('body-content')
    <div class="container-fluid">
            ...
            <div class="col-lg-3 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="mt-4">
                            @if (is_file(public_path('../files/user_photos/Companies/' . $company->com_logo)))
                                <img src="{{ asset('files/user_photos/Companies/' . $company->com_logo) }}"
                                    class="rounded-circle" width="100" height="100" id="profile-user-img"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                    data-bs-original-title="Click to change" />
                            @else
                                <img src="{{ asset('files/user_photos/logo.gif') }}" class="rounded-circle shadow-sm"
                                    width="100" height="100" id="profile-user-img" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="" data-bs-original-title="Click to change" />
                            @endif
                    ...
                    <div class="card-body pt-0 pb-0 " id="adrs">
                        ...
                        <span id="comp_add"
                            class="text-dark">{{ $company->address != null ? $company->address : '' }}</span>
                        <span id="comp_apprt"
                ...
                <div class="card">
                    <div class="card-body soc-card">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{ $company->twitter }}" id="twt" title="Twitter" class="btn btn-circle"
                                target="_blank" style="color: #009efb;font-size:24px">
                                <i class="soc-ico  fab fa-twitter"></i>
                            </a>

                            <a href="{{ $company->fb }}" id="fb_icon" title="Facebook" class="btn btn-circle"
                                target="_blank" style="color:#0570E6;font-size:24px">
                                <i class="soc-ico fab fa-facebook"></i>
                            </a>

                            <a href="{{ $company->pinterest }}" id="pintrst" title="Pinterest" class="btn btn-circle"
                                target="_blank" style="color:#DF1A26;font-size:24px">
                                <i class="soc-ico  fab fa-pinterest-square"></i>
                            </a>

                            <a href="{{ $company->insta }}" id="inst" title="Instagram" class="btn btn-circle"
                                target="_blank" style="color:#e1306c;font-size:24px">
                                <i class="soc-ico  fab fa-instagram"></i>
                            </a>

                            <a href="{{ $company->website }}" id="web" title="Website" class="btn btn-circle"
                                target="_blank" style="font-size:24px">
            ...
            <div class="col-lg-9 col-xlg-9 col-md-7 ">
                <div class="card">
                    ...
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="orders-profile-tab" data-toggle="pill" href="#orders"
                                role="tab" aria-controls="pills-profile" aria-selected="false">Billing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="payment-profile-tab" data-toggle="pill" href="#payment"
                                role="tab" aria-controls="pills-profile" aria-selected="false">Payments</a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tickets-tab" data-toggle="pill" href="#tickets"
                                role="tab" aria-controls="pills-tickets" aria-selected="false">Tickets</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#comp_profile"
                                role="tab" aria-controls="pills-profile" aria-selected="false">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-staff-tab" data-toggle="pill" href="#staff" role="tab"
                                aria-controls="pills-staff" aria-selected="false">Staff</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="notes-profile-tab" data-toggle="pill" href="#ticket_notes"
                                role="tab" aria-controls="pills-profile" aria-selected="false">Notes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="settings-profile-tab" data-toggle="pill" href="#ticket_settings"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <form id="CardForm" class="CardForm">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                placeholder="Street Address" name="address1"
                                                                id="address1" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <select class="select2 form-control " id="state"
                                                                name="state" style="width: 100%; height:36px;"></select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                placeholder="Zip code" name="zip" id="zip"
                                                                value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            @if ($google_key == 1)
                                                                <input type="text" class="form-control"
                                                                    placeholder="Zip code" name="country" id="country"
                                                                    value="">
                                                            @else
                                                                <select class="form-control" name="country"
                                                                    ...
                                                                    @foreach ($countries as $cty)
                                                                        @if (!empty($company->cmp_country) && $cty->name == $company->cmp_country)
                                                                            <option value="{{ $cty->name }}" selected>
                                                                                {{ $cty->name }}</option>
                                                                        @else
                                            ...
                                            <form id="" class="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control"
                                                                placeholder="Company Name" name="" id=""
                                                                value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Zip code" name="payment_billing_zipcode"
                                                                id="payment_billing_zipcode" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="card p-3">
                                                                        ...
                                                                        <a class="buttonPush"
                                                                            href="javascript:fieldAdd('url')">
                                                                            <div class="card border-cyan card-hover mb-2">
                                                                                <div class="box p-2 rounded">
                                                                                    <!-- <h5 class="font-weight-light text-cyan"></h5> -->
                                                                                    <h6 class="text-cyan"><i
                                                                                            class="fas fa-laptop-code pr-2"></i>URL
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                                        <a class="buttonPush"
                                                                            href="javascript:fieldAdd('address')">
                                                                            <div class="card border-cyan card-hover mb-2">
                                                                                <div class="box p-2 rounded">
                                                                                    <!-- <h5 class="font-weight-light text-cyan"></h5> -->
                                                                                    <h6 class="text-cyan"><i
                                                                                            class="fas fa-map-marked-alt pr-2"></i>Address
                                                                                    </h6>
                                                                                </div>
                                                                            </div>
                                                                        </a>
                                                ...
                                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                                    ...
                                                    <div class="card-body">
                                                        <form class="form-horizontal" id="save_asset_form"
                                                            ...
                                                            <div class="form-row" id="templateTitle"
                                                                style="display:none;">
                                                                <div class="col-md-12 form-group">
                                                                    <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="comp_profile" role="tabpanel"
                                ...
                                <form id="update_company" onsubmit="return false">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" id="name" name="name"
                                                placeholder="Johnathan Doe" value="{{ $company->name }}"
                                                class="form-control">
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-control custom-checkbox mr-sm-2">
                                                    <input type="checkbox" class="custom-control-input"
                                                        name="set_default" id="set_default">
                                                    <label class="custom-control-label" for="set_default">Set as
                                                        Default</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3 form-group">
                                            <label>City</label>
                                            <input type="text" name="cmp_city" id="cmp_city"
                                                value="{{ $company->cmp_city }}" class="form-control form-control-line">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            @if ($google_key == 1)
                                                <input type="text" class=" form-control" id="cmp_state"
                                                    name="cmp_state" value="{{ $company->cmp_state }}"
                                                    style="width: 100%; height:36px;">
                                            @else
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="cmp_zip" id="cmp_zip"
                                                value="{{ $company->cmp_zip }}" class="form-control form-control-line">
                                            <span class="text-danger" id="err8"></span>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Country</label>
                                            @if ($google_key == 1)
                                                <input type="text" class=" form-control " id="cmp_country"
                                                    name="cmp_country" value="{{ $company->cmp_country }}"
                                                    style="width: 100%; height:36px;">
                                            @else
                                                <select class="select2 form-control " id="cmp_country"
                                                    name="cmp_country" style="width: 100%; height:36px;"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" id="fb" name="fb"
                                                placeholder="https://facebook.com/username" value="{{ $company->fb }}"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-6 form-group">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12 form-group">
                                            ...
                                            <input type="text" name="website" value="{{ $company->website }}"
                                                class="form-control" placeholder="https://www.yourwebsite.com"
                                                id="update_website">
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                @if ($company->is_default == 1)
                                                    <button type="button" class="btn btn-info btn-sm rounded"
                                                        data-toggle="modal" data-target="#add_comp_user_model"
                                                        style="float:right;top: -35px;position: relative;">
                                                        <i class="fas fa-plus"></i>&nbsp;Add User</button>
                                                @else
                                                    <button type="button" class="btn btn-info btn-sm rounded"
                                                        data-toggle="modal" data-target="#add_staff_model"
                                                        style="float:right;top: -35px;position: relative;">
                                                        ...
                                                        <tbody>
                                                            @foreach ($company_staff as $staff)
                                                                <tr>
                                                                    ...
                                                                    <td> <a
                                                                            href="{{ url('customer-profile') }}/{{ $staff->id }}">{{ $staff->first_name }}
                        ...
                        <div class="tab-pane fade" id="ticket_notes" role="tabpanel"
                            aria-labelledby="notes-profile-tab">
                            <hr>
                            <div class="card-body">
                                No Data Found.
                            </div>
                        ...
                        <div class="tab-pane fade" id="ticket_settings" role="tabpanel"
                            ...
                            <div class="card-body">
                                <form id="update_company" onsubmit="return false">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-12">
                                            <label>SLA</label>
                                            <select class="select2 form-control custom-select" id="com_sla"
                                                name="tags" multiple="multiple" style="height: 36px;width: 100%;">
                                                @foreach ($sla_plans as $sla)
                                                    <option value="{{ $sla->id }}"
                                                        {{ $sla->id == 2, 4 ? 'selected' : '' }}>{{ $sla->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="select2 form-control custom-select" id="domain"
                                                name="domain" multiple="multiple"
                                                style="height: 36px;width: 100%;"></select>
                                            <div class="row mt-3 ml-2">
                                                ...
                                                <div class="custom-control custom-radio ml-3">
                                                    ...
                                                    <input type="radio" id="date_range"
                                                        onclick="filterData('date_range')" name="customRadio"
                                                        class="custom-control-input">
                                                    <label class="custom-control-label" for="date_range">Date
                                                        Range</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn btn-success rounded btn-sm"
                                        onclick="saveCompanySLA()">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center">
                        ...
                        <div class="alert alert-success" role="alert"
                            style="position:relative;left:477px;margin:unset;">
        ...
        <!--staff add model-->
        <div class="modal fade" id="add_staff_model" role="dialog" data-backdrop="static"
            aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center">
                    ...
                    <div class="modal-body">
                        <form class="companyUser" id="companyStaffForm" autocomplete="off"
                            enctype="multipart/form-data" method="POST" action="{{ url('save-company-staff') }}">
                            <input type="hidden" name="company_id" value="{{ $company->id }}">
                            <input type="hidden" name="type" value="customer">
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <label for="first_name" class="small">First Name <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="staff_first_name"
                                        id="staff_first_name" placeholder="Your first name" required>
                                    <span class="text-danger name_error small"></span>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="last_name" class="small">Last Name<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="staff_last_name"
                                        id="staff_last_name" placeholder="Your Last name" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="email" class="small">Email Address<span
                                            class="text-danger">*</span></label>
                                    <input type="email" class="form-control small" name="staff_email"
                                        id="staff_email" placeholder="youe email address" required>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="companyUser" id="companyStaffForm" autocomplete="off"
                            ...
                            <div class="form-row">
                                <div class="col-md-6 form-group">
                                    <label for="first_name" class="small">Name <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="email" class="small">Email Address<span
                                            class="text-danger">*</span></label>
                                    <input type="email" class="form-control small" name="staff_email"
                                        id="staff_email" placeholder="your email address" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="password" class="small"> Password <span
                                            class="text-danger">*</span></label>
                                    <input type="password" class="form-control small" name="staff_password"
                                        id="staff_email" placeholder="your Password" required>
                                </div>
                            </div>
    ...
    @endif -->
        ...
        <div id="fields-modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
    ...
    <div id="update_asset_modal" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info p-2">
                    <span>
                        <h4 style="color:#fff !important;" id="headinglabel"> Update - <span id="modal-title"></span>
                        </h4>
                    </span>
                </div>
                <div class="modal-body">
    ...
    <!-- Notes Modal -->
    <div class="modal fade" id="notes_manager_modal" tabindex="-1" role="dialog" data-backdrop="static"
        aria-labelledby="notesLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center">
