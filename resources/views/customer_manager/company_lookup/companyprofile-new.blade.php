                ...
                <div class="card">
                        ...
                        <h2 class="mt-4 font-weight-bold text-dark">Social Links</h2>
                            <div class="d-flex justify-content-center">
                                <a href="{{$company->twitter}}" id="twt" title="Twitter" class="btn btn-circle social" target="_blank" style="color: #009efb;font-size:20px">
                                    <i class="soc-ico  fab fa-twitter"></i>
                                </a>
    
                                <a href="{{$company->fb}}" id="fb_icon" title="Facebook" class="btn btn-circle social" target="_blank" style="color:#0570E6;font-size:20px">
                                    <i class="soc-ico fab fa-facebook"></i>
                                </a>
    
                                <a href="{{$company->pinterest}}" id="pintrst" title="Pinterest" class="btn btn-circle social" target="_blank" style="color:#DF1A26;font-size:20px">
                                    <i class="soc-ico  fab fa-pinterest-square"></i>
                                </a>
    
                                <a href="{{$company->insta}}" id="inst" title="Instagram" class="btn btn-circle social" target="_blank" style="color:#e1306c;font-size:20px">
                                    <i class="soc-ico  fab fa-instagram"></i>
                                </a>  
    
                                <a href="{{$company->website}}" id="web" title="Website" class="btn btn-circle social" target="_blank" style="font-size:20px">
            ...
            <div class="col-lg-9 col-xlg-9 col-md-7">
                <div class="card">
                    ...
                    <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-timeline-tab" data-bs-toggle="tab" href="#current-month" role="tab" aria-controls="pills-timeline" aria-selected="true">History</a>
                        </li>
                        <!--<li class="nav-item">-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="orders-profile-tab" data-bs-toggle="tab" href="#orders" role="tab" aria-controls="pills-profile" aria-selected="false">Billing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="payment-profile-tab" data-bs-toggle="tab" href="#payment" role="tab" aria-controls="pills-profile" aria-selected="false">Payments</a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="pills-assets-tab" data-bs-toggle="tab" href="#assets" role="tab" aria-controls="pills-assets" aria-selected="false">Assets</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-tickets-tab" data-bs-toggle="tab" href="#tickets" role="tab" aria-controls="pills-tickets" aria-selected="false">Tickets</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="tab" href="#comp_profile" role="tab" aria-controls="pills-profile" aria-selected="false">Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-staff-tab" data-bs-toggle="tab" href="#staff" role="tab" aria-controls="pills-staff" aria-selected="false">Staff</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="notes-profile-tab" data-bs-toggle="tab" href="#ticket_notes" role="tab" aria-controls="pills-profile" aria-selected="false">Notes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="settings-profile-tab" data-bs-toggle="tab" href="#ticket_settings" role="tab" aria-controls="pills-setting" aria-selected="false">Settings</a>
                        </li>
                    </ul>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    @if($company->is_default == 1)
                                                        <button type="button" class="btn btn-info rounded float-btn" data-bs-toggle="modal" data-bs-target="#add_comp_user_model" style="">
                                                            <i class="fas fa-plus"></i>&nbsp;Add User</button>
                                                    @else
                                                        <button type="button" class="btn btn-info rounded float-btn" data-bs-toggle="modal" data-bs-target="#add_staff_model" style="">
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form class="companyUser" id="companyStaffForm" autocomplete="off" enctype="multipart/form-data" method="POST" action="{{url('save-company-staff')}}">
            ...
            <button type="submit" class="btn btn-success btn-sm rounded float-right mr-2 mt-1 savingBtn float-btn">
                <i class="fas fa-check-circle" aria-hidden="true"></i> Save</button>
            <button type="button" disabled="" style="display:none" class="btn btn-success btn-sm rounded float-right mr-2 mt-1 processingBtn"> 
...
<!-- Modal -->
<div class="modal fade text-start" id="editPicModal" tabindex="-1" aria-labelledby="editPicModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <form id="update_assets_form" enctype="multipart/form-data" onsubmit="return false">
            ...
            <div class="form-group text-right mt-3">
                <button class="btn btn-rounded btn-success float-btn" style="margin-left: 5px" onclick="updateAssets()" id="sve" type="submit">Save</button>
                <button class="btn btn-rounded btn-danger float-btn" type="button" data-dismiss="modal">Close</button>
            </div>
        </form>
