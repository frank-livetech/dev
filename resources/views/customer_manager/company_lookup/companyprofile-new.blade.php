                                                ...
                                                <div class="accordion-body">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="">
                                                                <div class="card"
                                                                    style="box-shadow: 0 12px 24px 0 rgb(34 41 47 / 32%) !important;">
                                                                    <div class="row p-1">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label for="tempTitle">Template
                                                                                    Title</label>
                                                                ...
                                                                <div class="row ">
                                                                    <div class="col-md-4">
                                                                        <div class="card p-1"
                                                                            ...
                                                                            <a class="buttonPush"
                                                                                ...
                                                                                <div
                                                                                    class="card border-cyan card-hover mb-1">
                                                                                    <button type="button"
                                                                            ...
                                                                            <a class="buttonPush"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        class="btn btn-outline-success waves-effect"><i
                                                                                            class="fas fa-laptop-code pr-2"></i>
                                                                                        URL</button>
                                                                            ...
                                                                            <a class="buttonPush"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        class="btn btn-outline-success waves-effect"><i
                                                                                            class="fas fa-map-marked-alt pr-2"></i>
                                                                                        Address</button>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <div class="card"
                                                                            ...
                                                                            <div class="m-1">
                                                                                <button type="button"
                                                                                    class="btn btn-success float-btn ml-2"
                                                                                    onclick="saveTemplate()"
                                                                                    style="margin-left: 5px"> Save
                                                                                    Template </button>
                                                                                <button type="button"
                                                                                    class="btn btn-info float-btn"
                                                                            ...
                                                                            <div class="row p-1">
                                                                                <div class="col-md-12 pt-1 ">
                                                                                    <div class="head text-center ">
                                                                                        <h4> Please Insert a Field Here
                                                                                            from Insert Field Button
                                                                                        </h4>
                                                                                    </div>
                                                                                    <div id="cardycard">
                                                                                    </div>
            ...
            <div class="modal-body">
                <form id="update_assets_form" enctype="multipart/form-data" onsubmit="return false">
                    ...
                    <div class="form-group text-right mt-3">
                        <button class="btn btn-rounded btn-success float-btn" style="margin-left: 5px"
                            onclick="updateAssets()" id="sve" type="submit">Save</button>
                        <button class="btn btn-rounded btn-danger float-btn" type="button"
