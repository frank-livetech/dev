                        ...
                        <div class="card-body">
                            ...
                            <div class="info-container">
                                ...
                                <div class=" justify-content-center pt-2">
                                    <a href="{{url('logged_in_as_customer').'/'.$customer->email}}" target="__blank" class="btn btn-primary me-1">Login as {{$customer->first_name}} {{$customer->last_name}}</a>
                                    
                                    <a href="javascript:;" class="btn btn-outline-danger suspend-user mt-1 text-center mx-5">Suspended</a>
                                </div>
                            </div>
                        </div>
                    </div>
