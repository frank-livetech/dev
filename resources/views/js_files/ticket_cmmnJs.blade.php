    ...
    function get_ticket_table_list() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.hasOwnProperty('unassigned_tickets_count')) $('#unassigned_tickets_count_col').html(data.unassigned_tickets_count);
                if (data.hasOwnProperty('late_tickets_count')) $('#late_tickets_count_col').html(data.late_tickets_count);
                if (data.hasOwnProperty('trashed_tickets_count')) $('#trashed_tickets_count_col').html(data.trashed_tickets_count);
        ...
        $.each(ticket_arr, function(key, val) {
            ...
            if (val['assignee_img'] != null && val['assignee_img'].length != 0) {
                ...
                assignee = `<div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="" class="avatar pull-up" data-bs-original-title="Unassigned">
                            <i class="far fa-user-clock" width="33" height="33" style="width:33px;height:33px;color:black"></i>
                            </div>`
            }
