...
!(function (a, b) {
    ...
    (k = "caret"),
        (b = (function () {
            ...
            return (
                ...
                (b.prototype.getOldIEOffset = function () {
                    var a, b;
                    return (
                        (a = h.selection.createRange().duplicate()),
                        a.moveStart("character", -1),
                        (b = a.getBoundingClientRect()),
                        { height: b.bottom - b.top, left: b.left, top: b.top }
                    );
                }),
                (b.prototype.getOffset = function () {
                    var b, c, d, e, f;
                    return (
                        j.getSelection && (d = this.range())
                            ? (d.endOffset - 1 > 0 &&
                                  d.endContainer !== this.domInputor &&
                                  ((b = d.cloneRange()),
                                  b.setStart(d.endContainer, d.endOffset - 1),
                                  ...
                                  b.detach()),
                              (c && 0 !== (null != c ? c.height : void 0)) ||
                                  ((b = d.cloneRange()),
                                  (f = a(h.createTextNode("|"))),
                                  b.insertNode(f[0]),
                                  b.selectNode(f[0]),
                                  (e = b.getBoundingClientRect()),
                                  (c = {
                ...
                (b.prototype.range = function () {
                    ...
                    if (j.getSelection)
                        return (
                            (a = j.getSelection()),
                            a.rangeCount > 0 ? a.getRangeAt(0) : null
                        );
                }),
                b
            );
        ...
        (c = (function () {
            ...
            return (
                (b.prototype.getIEPos = function () {
                    var a, b, c, d, e, f, g;
                    return (
                        (b = this.domInputor),
                        (f = h.selection.createRange()),
                        (e = 0),
                        f &&
                            f.parentElement() === b &&
                            ((d = b.value.replace(/\r\n/g, "\n")),
                            ...
                            a.collapse(!1),
                            (e =
                                g.compareEndPoints("StartToEnd", a) > -1
                                    ? c
                                    : -g.moveStart("character", -c))),
                        e
                    );
                }),
                (b.prototype.getPos = function () {
                    return h.selection
                        ? this.getIEPos()
                        : this.domInputor.selectionStart;
                }),
                (b.prototype.setPos = function (a) {
                    var b, c;
                    return (
                        ...
                        h.selection
                            ? ((c = b.createTextRange()),
                              c.move("character", a),
                              c.select())
                            : b.setSelectionRange && b.setSelectionRange(a, a),
                        b
                    );
                }),
                (b.prototype.getIEOffset = function (a) {
                    var b, c, d, e;
                    return (
                        (c = this.domInputor.createTextRange()),
                        a || (a = this.getPos()),
                        c.move("character", a),
                        (d = c.boundingLeft),
                        (e = c.boundingTop),
                        (b = c.boundingHeight),
                        { left: d, top: e, height: b }
                    );
                }),
                (b.prototype.getOffset = function (b) {
                    ...
                    return (
                        (c = this.$inputor),
                        h.selection
                            ? ((d = this.getIEOffset(b)),
                              (d.top += a(j).scrollTop() + c.scrollTop()),
                              (d.left += a(j).scrollLeft() + c.scrollLeft()),
                              d)
                            : ((d = c.offset()),
                ...
                (b.prototype.getIEPosition = function (a) {
                    var b, c, d, e, f;
                    return (
                        (d = this.getIEOffset(a)),
                        (c = this.$inputor.offset()),
                        (e = d.left - c.left),
                        (f = d.top - c.top),
                        (b = d.height),
                        { left: e, top: f, height: b }
                    );
                }),
                b
            );
        ...
        (d = (function () {
            ...
            return (
                ...
                (b.prototype.mirrorCss = function () {
                    var b,
                        c = this;
                    return (
                        (b = {
                        ...
                        "TEXTAREA" === this.$inputor.prop("tagName") &&
                ...
                (b.prototype.rect = function () {
                    ...
                    return (
                        ...
                        (b = a.position()),
                        (c = { left: b.left, top: b.top, height: a.height() }),
                        this.$mirror.remove(),
                        c
                    );
                }),
        ...
        (e = {
            contentEditable: function (a) {
                return !(
                    !a[0].contentEditable || "true" !== a[0].contentEditable
                );
            },
        }),
        (g = {
        ...
        (l = function (a) {
            var b;
            return (b = null != a ? a.iframe : void 0)
                ? ((i = b),
                  (j = b.contentWindow),
                  (h = b.contentDocument || j.document))
                : ((i = void 0), (j = window), (h = document));
        }),
        (f = function (a) {
            var b;
        ...
        (a.fn.caret = function (d, f, h) {
            var i;
            return g[d]
                ? (a.isPlainObject(f) ? (l(f), (f = void 0)) : l(h),
                  (i = e.contentEditable(this) ? new b(this) : new c(this)),
                  g[d].apply(i, [f]))
                : a.error("Method " + d + " does not exist on jQuery.caret");
        }),
        (a.fn.caret.EditableCaret = b),
        (a.fn.caret.InputCaret = c),
        (a.fn.caret.Utils = e),
        (a.fn.caret.apis = g);
});
