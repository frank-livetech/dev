...
<div class="container-fluid">
    <form  id="addProducts">    
        <input type="hidden" id="is_type" name="is_type" value="{{$product->is_type}}">
        <input type="hidden" id="is_submit" name="is_submit" value="{{$product->is_submit}}">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <p>Permalink: mailkdejbh_mylivetech.com <a type="button" onclick="showTitle()" class="text-dark"><i class="fas fa-pencil-alt "></i></a></p>
                    </div>
                    <div class=" col-md-12 pb-5">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="home">
                                    ...
                                    <textarea name="long_desc" id="long_desc" class="form-control " rows="10" value="{{$product->long_desc}}">
                                    {{$product->long_desc}}
                                    </textarea>
                            </div>
                            <div class="tab-pane show" id="profile">
                                    <label for="" class="text-red">Standard TinyMCE here</label>
                                    <textarea name="specs" id="specs" class="form-control " rows="10" value="{{$product->specs}}">
                                    {{$product->specs}}
                                    </textarea>
                            </div>
                            <div class="tab-pane " id="settings">
                                    <label for="" class="text-red">Standard TinyMCE here</label>
                                    <textarea name="extra_details" id="extra_details" class="form-control " rows="10" value="{{$product->extra_details}}">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <div class="form-check form-check-inline">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" id="sell_as_sub_enable" name="sell_as_sub" value="">
                            ...
                            <div class="col-md-12 form-row pt-5">
                                ...
                                <input type="text " class="form-control col-sm-4" name="how_often_quantity" id="how_often_quantity" value="{{$product->how_often_quantity}}" placeholder="5">
                                <select type="text " name="how_often_terms" id="how_often_terms" class="form-control col-sm-3 ml-3">
                                    <option value="">
                                        Term
                                    </option>
                                </select>
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <textarea name="short_desc" id="short_desc"  class="form-control col-md-12 mb-3" value="{{$product->short_desc}}">{{$product->short_desc}}</textarea>
                        <div class="text-right">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <input type="text" value="{{$product->upc_gtin}}" class=" form-control mb-3 hard_goods_field" id="upc_gtin" name="upc_gtin" placeholder="UPC# / GTIN#" >
                                        <input type="text" value="{{$product->isbn}}" class=" form-control " id="isbn" name="isbn" placeholder="ISBN# for books only" >
                                        <input type="text" value="{{$product->part_no}}" class=" form-control mt-3 hard_goods_field" placeholder="Part Number" id="part_no" name="">
                                        <input type="text" value="{{$product->brand_no}}" class=" form-control mt-3" placeholder="Brand Name" id="brand_no" name="brand_no">
                                        <input type="text" value="{{$product->sku}}" class=" form-control mt-3" placeholder="SKU" id="sku" name="sku">
                                        <input type="text" value="{{$product->internal_id}}" class=" form-control mt-3" placeholder="Internal ID" id="internal_id" name="internal_id">
                                    ...
                                    <div class="col-md-6 digital_goods_field">
                                        ...
                                        <select name="" id="allow_download_for" class="form-control mt-3">
                                    ...
                                    <div class="col-md-6 hard_goods_field">
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="in_stock" name="in_stock" value="{{$product->in_stock}}">
                                                    <label class="custom-control-label" for="stock">  How Many in Stock? </label>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <input type="number" class=" form-control" id="stock_quantity" name="stock_quantity" value="{{$product->stock_quantity}}" placeholder="$xx.xx">
                                            </div>                            
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-md-12">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="is_stock_on_mul_loc" name="is_stock_on_mul_loc" value="{{$product->is_stock_on_mul_loc}}">
                                                    <label class="custom-control-label" for="stock">  Is stock in more than 1 location? </label>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <input type="text" class=" form-control" placeholder="Location 2 Optional" id="stock_loc_2" name="" value="{{$product->stock_loc_2}}">
                                            </div>
                                            <div class="col-md-12 mt-2">
                                                <input type="text" class=" form-control" placeholder="Location 3 Optional" id="stock_loc_3" name="" value="{{$product->stock_loc_3}}">
                                            </div>                             
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <textarea name="special_condition_text" id="special_condition_text" class="form-control"  rows="6" value="{{$product->special_condition_text}}">
                                        {{$product->special_condition_text}}
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row form-group">
                                    ...
                                    <input for="" class="col-sm-5 form-control" value="{{$product->vendor_price}}" id="vendor_price" name="vendor_price">
                                </div>
                                <div class="row form-group">
                                <label for="" class="col-sm-4" data-toggle="tooltip" data-placement="top" title="Optional put a discounted rate the customer will see">My Sale Price</label>
                                    <input for="" class="col-sm-5 form-control" id="oor_sale_price" name="oor_sale_price" value="{{$product->oor_sale_price}}">
                                ...
                                <label for="" class="col-sm-4" data-toggle="tooltip" data-placement="top" title="This is the rate your item will sell for when not on sale at discounted rate.">My Regular Price</label>
                                    ...
                                    <input for="" class="col-sm-5 form-control" id="oor_regular_price" name="oor_regular_price" value="{{$product->oor_regular_price}}">
                                </div>
                                <div class="row form-group">
                                <label for="" class="col-sm-4" data-toggle="tooltip" data-placement="top" title="This is the cost the menufacture suggests should be sold at">MSRP</label>
                                    <input for="" class="col-sm-5 form-control" id="msrp" name="msrp" value="{{$product->msrp}}">
                                </div>
                                <div class="row form-group">
                                <label for="" class="col-sm-4" data-toggle="tooltip" data-placement="top" title="This is special discounted rrate to sell your  items to resellers. Requires customer users to have Wholesale role added first before they will see pricing.">Wholesale</label>
                                    <input for="" class="col-sm-5 form-control" id="wholesale_price" name="wholesale_price" value="{{$product->wholesale_price}}">
                                </div>

                                <div class="row form-group">
                                    <label for="" class="col-sm-12"> Shopping Details</label>
                                    <input type="text" class="col-sm-3 ml-3 form-control" name="length" id="length" value="{{$product->length}}" placeholder="Length">
                                    <input type="text" class="col-sm-3 ml-2 form-control" name="width" id="width" placeholder="Width" value="{{$product->width}}">
                                    <input type="text" class="col-sm-3 ml-2 form-control" name="height" id="height" placeholder="Height" value="{{$product->height}}">
                                    <input type="text" class="col-sm-10 mt-2 ml-3 form-control" name="weight" id="weight" placeholder="Weight 15lbs" value="{{$product->weight}}">
                                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" data-show-errors="true" id="feature_image" class="dropify" data-height="150"
                                    data-default-file="{{asset('public/files/products_imgs')}}/{{$product->feature_image}}" 
                                    name="feature_image" onchange="loadFile(this);" data-max-file-size="2M"/>
                                </div>
                            ...
                            <div class="col-md-2 text-center">
                                ...
                                <img src="{{asset('public/files/products_imgs')}}/{{$product->feature_image}}" class="img-fluid" alt="" style="max-height:172px;width:auto;">
                            </div>
                            <div class="col-md-7">
                                <div class="col-md-12">
                                    <div class="form-check form-check-inline">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3">
                                <input type="file" data-show-errors="true" id="feature_video" value="{{$product->feature_video}}" name="feature_video" onchange="loadFile(this);" data-max-file-size="2M"/>
...
@endsection
@section('scripts')
    @include('js_files.marketing.edit_goodsJs')
@endsection
